...
//inline infix fun <当前值, 计算值> 当前值.大于(乙: 计算值) = 自身 > 乙
//inline infix fun <当前值, 计算值> 当前值.大于等于(乙: 计算值) = 自身 >= 乙
//inline infix fun <当前值, 计算值> 当前值.小于(乙: 计算值) = 自身 < 乙
//inline infix fun <当前值, 计算值> 当前值.小于等于(乙: 计算值) = 自身 <= 乙
//
//inline infix fun <当前值, 计算值> 当前值.包含(乙: 计算值) = 自身.contains(乙)
//inline infix fun <当前值, 计算值> 当前值.不包含(乙: 计算值) = !自身.contains(乙)
//
//inline infix fun <当前值, 计算值> 当前值.加(乙: 计算值) = 自身 + 乙
//inline infix fun <当前值, 计算值> 当前值.减(乙: 计算值) = 自身 - 乙
//inline infix fun <当前值, 计算值> 当前值.乘(乙: 计算值) = 自身 * 乙
//inline infix fun <当前值, 计算值> 当前值.除(乙: 计算值) = 自身 / 乙
//inline infix fun <当前值, 计算值> 当前值.余(乙: 计算值) = 自身 % 乙
//
//inline infix fun <当前值, 计算值> 当前值.自加(乙: 计算值) = 自身 += 乙
//inline infix fun <当前值, 计算值> 当前值.自减(乙: 计算值) = 自身 -= 乙
//inline infix fun <当前值, 计算值> 当前值.自乘(乙: 计算值) = 自身 *= 乙
//inline infix fun <当前值, 计算值> 当前值.自除(乙: 计算值) = 自身 /= 乙
//inline infix fun <当前值, 计算值> 当前值.自余(乙: 计算值) = 自身 %= 乙
//
//inline val <当前值> 当前值.递增 get() = 自身++
//inline val <当前值> 当前值.递减 get() = 自身--
//
//inline infix fun <当前值, 计算值> 当前值.到(乙: 计算值) = 自身..乙
